 ...
 */
package clinicmanagement.commons;
...
/**
 *
 * in this class, we manage text files, and with import this class to other
 * classes we can manage our files that store data and CRUD them.
 */
