...
import clinicmanagement.GUI.ManagerForm;
import clinicmanagement.GUI.RegisterForm;
import clinicmanagement.identities.Section;
import clinicmanagement.manage.ManageSections;
 ...
 */
public class AddNewSection extends javax.swing.JFrame {

    /**
     * Creates new form AddNewSection
     */
    ...
    private void initComponents() {
        ...
        jLabel6.setText("نوع بخش :");

        jSeparator2.setForeground(new java.awt.Color(255, 255, 255));

        btnBack.setFont(new java.awt.Font("W_yekan Bold", 0, 14)); // NOI18N
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        ...
        sec.setName(txtName.getText());
        sec.setType(txtType.getText());
        

        /*
        insert the section into sections file
        */
        ManageSections ms = new ManageSections();
        ms.insert(sec);
        /*
        send a massage to user for add section to file
        */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddNewSection.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddNewSection().setVisible(true);
            }
        });
    }
